    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 flex items-center justify-center p-4 relative">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="absolute -top-16 left-1/2 transform -translate-x-1/2">
          <div className="w-6 h-12 relative animate-pulse">
            <div className="w-8 h-8 bg-white rounded-full shadow-lg border-2 border-gray-200 absolute -top-2 left-1/2 transform -translate-x-1/2">
            ...
            <div className="w-1 h-8 bg-green-600 mx-auto rounded-full"></div>
          </div>
        </div>
        ...
        <Card className="w-full shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
          ...
          <CardContent className="pt-0">
            ...
            {/* Conditionally render Google sign-up section */}
            {isGoogleProviderAvailable && (
              <>
                ...
                <div key="google-signup" className="mt-6">
                  <Button
                    type="button"
